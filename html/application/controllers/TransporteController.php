...
class TransporteController extends Escola_Controller_Logado {
    ...
    public function transporteformAction() {
        ...
        if ($obj) {
            $this->view->result = utf8_encode($obj->render($this->view));
        }
    }
    ...
    public function indexAction() {
        ...
        $button->setTitulo("CADASTRO DE TR?NSITO");
            ...
            try {
                ...
                if (isset($dados["id_pessoa"]) && $dados["id_pessoa"]) {
                    ...
                    if ($tpt) {
                        ...
                        $tp = $tb->createRow();
                        $tp->setFromArray(array("id_transporte_pessoa_tipo" => $tpt->getId(),
    ...
    public function excluirAction() {
        ...
        if ($id) {
            ...
            if ($registro) {
                ...
                if (!$errors) {
                    $registro->delete();
                    $this->_flashMessage("OPERA??O EFETUADA COM SUCESSO!", "Messages");
                } else {
                ...
                $this->_flashMessage("INFORMA??O RECEBIDA INV?LIDA!");
            }
        } else {
            $this->_flashMessage("NENHUMA INFORMA??O RECEBIDA!");
        }
        $this->_redirect($this->_request->getControllerName() . "/index");
    }
        ...
        if ($id) {
            ...
            if ($transporte) {
                ...
                $button->addFromArray(array("titulo" => "Excluir",
                    ...
                    "class" => "link_excluir",
                    "params" => array("id" => $id)));
                $button->addFromArray(array("titulo" => "Pessoas",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "pessoa",
                    "img" => "icon-group",
                    "params" => array("id" => 0, "id_transporte" => $id)));
                $button->addFromArray(array("titulo" => "Ve?culos",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "veiculo",
                    "img" => "icon-truck",
                    "params" => array("id" => 0, "id_transporte" => $id)));
                $button->addFromArray(array("titulo" => "Servi?os",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "licenca",
                    "img" => "icon-copy",
                    "params" => array("id" => 0, "id_transporte" => $id)));
                $button->addFromArray(array("titulo" => "Relat?rios",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "relatorio",
                    "img" => "icon-print",
                    "params" => array("id" => $id)));
    ...
    public function pessoaAction() {
        ...
        if ($id) {
            ...
            if ($transporte) {
                ...
                $button = Escola_Button::getInstance();
                $button->setTitulo("CADASTRO DE TR?NSITO > PESSOAS");
                /*
    ...
    public function veiculoAction() {
        ...
        if ($id) {
            ...
            if ($transporte) {
                ...
                $this->view->dados = $dados;
                $button = Escola_Button::getInstance();
                $button->setTitulo("CADASTRO DE TR?NSITO > VE?CULOS");
                $button->addFromArray(array("titulo" => "Adicionar",
                    "controller" => $this->_request->getControllerName(),
    ...
    public function editarveiculoAction() {
        ...
        if (!$registro->baixa()) {
            ...
            $button = Escola_Button::getInstance();
            if ($this->view->registro->getId()) {
                $button->setTitulo("CADASTRO DE TRANSPORTES > VE?CULO - ALTERAR");
            } else {
                $button->setTitulo("CADASTRO DE TRANSPORTES > VE?CULO - INSERIR");
            }
            $button->addScript("Salvar", "salvarFormulario('formulario')", "icon-save");
            $button->addFromArray(array("titulo" => "Voltar",
                "controller" => $this->_request->getControllerName(),
            ...
            $this->_flashMessage("VE?CULO EM BAIXA!");
            $this->_redirect($this->_request->getControllerName() . "/veiculo/id/0");
        }
    }
    ...
    public function viewveiculoAction() {
        ...
        if ($id) {
            ...
            if ($registro) {
                ...
                $button = Escola_Button::getInstance();
                $button->setTitulo("VISUALIZAR TRANSPORTE > VE?CULO");
                if ($registro->ativo()) {
                    $button->addFromArray(array("titulo" => "Excluir",
                        "controller" => $this->_request->getControllerName(),
                        ...
                        "class" => "link_excluir",
                        "params" => array("id" => $id)));
                    $button->addFromArray(array("titulo" => "Baixa",
                        "controller" => $this->_request->getControllerName(),
                        "action" => "baixa",
    ...
    public function licencaAction() {
        ...
        if ($id) {
            ...
            if ($transporte) {
                ...
                $button = Escola_Button::getInstance();
                $button->setTitulo("CADASTRO DE TR?NSITO > SERVI?OS");
                $button->addFromArray(array("titulo" => "Boleto ?nico",
                    "onclick" => "boleto()",
    ...
    public function baixaAction() {
        ...
        if ($registro) {
            ...
            if (!$registro->baixa()) {
                ...
                ;
                $button = Escola_Button::getInstance();
                $button->setTitulo("BAIXA DE VE?CULO");
                $button->addScript("Salvar", "salvarFormulario('formulario')", "icon-save");
                $button->addFromArray(array("titulo" => "Voltar",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "veiculo",
                ...
                $this->_flashMessage("VE?CULO J? EST? EM BAIXA!");
                $this->_redirect($this->_request->getControllerName() . "/veiculo/id/0");
            }
        } else {
            $this->_flashMessage("NENHUMA INFORMA??O RECEBIDA!");
    ...
    public function viewlicencaAction() {
        ...
        if ($id) {
            ...
            if ($ss) {
                ...
                $button = Escola_Button::getInstance();
                $button->setTitulo("VISUALIZAR TRANSPORTE > SERVI?O");
                if ($ss->pago()) {
                    if ($ss->valido()) {
                ...
                if (!$ss->pago()) {
                    ...
                    if ($this->_request->isPost()) {
                        try {
                            ...
                            if ($errors) {
                                throw new Exception("Falha ao Executar Opera??o: <ul><li>" . implode("</li><li>", $errors) . "</li></ul>");
                            }
                    ...
                    $button = Escola_Button::getInstance();
                    $button->setTitulo("VISUALIZAR TRANSPORTE > SERVI?O > PAGAMENTO");
                    ...
                    $this->_flashMessage("SOLICITA??O DE SERVI?O J? PAGA!");
    ...
    public function addservicoAction() {
        ...
        if ($tipo && $chave) {
            ...
            if ($sr) {
                ...
                if (!$stgs || !count($stgs)) {
                    $this->_flashMessage("NENHUM SERVI?O DISPON?VEL PARA O TRANSPORTE!");
                ...
                if ($this->_request->isPost()) {
                    try {
                        ...
                        $errors = $ss->getErrors();
                        if ($errors) {
                            throw new Exception("Falha ao Salvar Solicita??o de Servi?o: <ul><li>" . implode("</li><li>", $errors) . "</li></ul>");
                        }
                        $ss->save();

                        $this->_flashMessage("OPERA??O EFETUADA COM SUCESSO!", "Message");
                        $this->_redirect($this->_request->getControllerName() . "/licenca/id/0/id_transporte/{$transporte->getId()}");
                    } catch (Exception $ex) {
                        $this->view->actionErrors[] = $ex->getMessage();
                    }
                ...
                $button = Escola_Button::getInstance();
                $button->setTitulo("ADICIONAR SOLICITA??O DE SERVI?O");
                $button->addScript("Salvar", "salvarFormulario('formulario')", "icon-save");
    ...
    public function emitirAction() {
        ...
        try {
            $id = $this->_request->getParam("id");
            if (!$id) {
                throw new Escola_Exception("Falha ao Executar Opera??o, Servi?o N?o Localizado!");
            }
            ...
            if (!$ss->pago()) {
                throw new Escola_Exception("Falha ao Executar Opera??o, Solicita??o de Servi?o N?o Paga!");
            }

            $errors = $ss->validarEmitir();
            if ($errors) {
                throw new Escola_Exception("Falha ao Executar Opera??o: <ul><li>" . implode("</li><li>", $errors) . "</li></ul>");
            }

            $flag = $ss->toPDF();

            if (!$flag) {
                throw new Escola_Exception("Falha ao Executar Opera??o: Relat?rio N?o Dispon?vel!");
            }
    ...
    public function carteiraAction() {
        ...
        if (count($ids)) {
            ...
            $this->_flashMessage("FALHA AO EXECUTAR OPERA??O, NENHUMA PESSOA SELECIONADA!");
        }
    ...
    public function placaAction() {
        ...
        if ($registro) {
            ...
            $button = Escola_Button::getInstance();
            $button->setTitulo("TRANSPORTE > VE?CULO > ATRIBUIR PLACA");
            $button->addScript("Salvar", "salvarFormulario('formulario')", "icon-save");
            $button->addFromArray(array("titulo" => "Cancelar",
                "controller" => $this->_request->getControllerName(),
                "action" => "veiculo",
    ...
    public function relatorioAction() {
        try {
            $id = $this->_request->getParam("id");
            if (!$id) {
                throw new Exception("Nenhuma Informa??o Recebida!");
            }
            ...
            if (!$relatorios) {
                throw new Exception("Nenhum Relat?rio Dispon?vel!");
            }

            $this->view->relatorios = $relatorios;
            $button = Escola_Button::getInstance();
            $button->setTitulo("TR?NSITO > RELAT?RIO");
            ...
            if ($this->_request->isPost()) {
                ...
                if (isset($dados["operacao"]) && ($dados["operacao"] == "imprimir")) {
                    if (!isset($dados["id_relatorio"]) || !$dados["id_relatorio"]) {
                        $this->view->actionErrors[] = "FALHA AO GERAR RELAT?RIO, NENHUM RELAT?RIO SELECIONADO!";
                    } else {
                        ...
                        if ($relatorio) {
                            ...
                            $this->view->actionErrors[] = "FALHA AO GERAR RELAT?RIO!";
                        }
                    }
                }
                $this->view->dados = $dados;
    ...
    public function boletovencimentoAction() {
        ...
        try {
            ...
            if (!count($ids)) {
                throw new Exception("Falha ao Gerar Boleto, Nenhuma Solicita??o de Servico Selecionada!");
            }
    ...
    public function arquivoAction() {
        ...
        if (!$transporte) {
            $transporte = TbTransporte::pegaPorId($this->_request->getParam("id_transporte"));
        }
        if ($transporte) {
            $session->id_transporte = $transporte->getId();
            $this->view->transporte = $transporte;
            $tb = new TbDocumentoRef();
            $this->view->registros = $tb->listar_por_pagina(array("tipo" => "T", "chave" => $transporte->getId()));
            $button = Escola_Button::getInstance();
            $button->setTitulo("ARQUIVOS");
            if ($this->view->registros && count($this->view->registros)) {
                $button->addFromArray(array("titulo" => "Baixar",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "baixar",
                    "img" => "icon-download",
                    "params" => array("id_documento_ref" => 0, "id" => $transporte->getId())));
            }
            $button->addFromArray(array("titulo" => "Adicionar",
                "controller" => $this->_request->getControllerName(),
            ...
            $this->_flashMessage("FALHA AO EXECUTAR OPERA??O, DADOS INV?LIDOS!");
            $this->_redirect($this->_request->getControllerName() . "/index");
        }
    }
    ...
    public function viewarquivoAction() {
        $session = Escola_Session::getInstance();
        $transporte = false;
        if (isset($session->id_transporte) && $session->id_transporte) {
            $transporte = TbTransporte::pegaPorId($session->id_transporte);
        }
        if (!$transporte) {
            $transporte = TbTransporte::pegaPorId($this->_request->getParam("id"));
        }
        ...
        if ($transporte && $id) {
            ...
            if ($registro) {
                ...
                $button = Escola_Button::getInstance();
                $button->setTitulo("VISUALIZA??O DE ARQUIVO");
                $button->addFromArray(array("titulo" => "Voltar",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "arquivo",
                    "img" => "icon-reply",
    ...
    public function editararquivoAction() {
        ...
        if (!$transporte) {
            $transporte = TbTransporte::pegaPorId($this->_reques->getParam("id"));
        }
        if ($transporte) {
            $id = $this->_request->getParam("id_documento_ref");
            ...
            if ($this->_request->isPost()) {
                ...
                if (isset($dados["operacao"]) && ($dados["operacao"] == "set_documento")) {
                    $documento->addTransporte($transporte);
                    $this->_flashMessage("OPERA??O EFETUADA COM SUCESSO!", "Messages");
                    $this->_redirect($this->_request->getControllerName() . "/arquivo/id/" . $this->view->transporte->getId());
                } else {
                    if (!$documento) {
                        $tb = new TbDocumento();
    ...
    public function baixarAction() {
        ...
        if ($transporte) {
            $proprietario = $transporte->pegaProprietario();
            $tb = new TbDocumentoRef();
            $registros = $tb->listar(array("tipo" => "T", "chave" => $transporte->getId()));
            if ($registros && count($registros)) {
                $path_tmp = ROOT_DIR . $path_arquivo . "/tmp/{$transporte->getId()}/";
                if (!file_exists($path_tmp)) {
                    $flag = mkdir($path_tmp);
                    if (!$flag) {
                        $this->_flashMessage("FALHA AO EXECUTAR OPERA??O, IMPOSS?VEL CRIAR PASTA TEMPOR?RIA!");
                        $this->_redirect($this->_request->getControllerName() . "/arquivo/id/{$transporte->getId()}");
                    }
                }
                $files = glob($path_tmp . "*.*");
                    ...
                    if ($doc) {
                        ...
                        if ($arquivo && $arquivo->existe()) {
                            ...
                            if ($at) {
                                ...
                                $filename = str_replace(" ", "_", $filter->filter(Escola_Util::minuscula($proprietario->toString() . "__" . $doc->resumo)));
                ...
                $filename = str_replace(" ", "_", $filter->filter(Escola_Util::minuscula($proprietario->toString())));
                ...
                $this->_flashMessage("NENHUM ARQUIVO DISPON?VEL PARA IMPORTA??O!");
                $this->_redirect($this->_request->getControllerName() . "/arquivo/id/{$transporte->getId()}");
            }
        } else {
            $this->_flashMessage("FALHA AO EXECUTAR OPERA??O, DADOS INV?LIDOS!");
    ...
    public function solicitacaoservicodeleteAction() {
        try {
            $id = $this->_request->getParam("id");
            if (!$id) {
                throw new Exception("Falha ao Executar Opera??o, Solicita??o de Servi?o N?o Dispon?vel!");
            }
            ...
            if ($errors) {
                throw new UnexpectedValueException("Falha ao Executar Opera??o: <ul><li>" . implode("</li><li>", $errors) . "</li></ul>");
            }

            $ss->delete();
            $this->addMensagem("OPERA??O EFETUADA COM SUCESSO!");
        } catch (Exception $ex) {
            ...
            if ($tv) {
                if ($tv->baixa()) {
                    ...
                    if (!$tv->baixa()) {
                        ...
                        $this->addErro("FALHA AO EXECUTAR OPERA??O, DADOS INV?LIDOS!");
                    }
                } else {
                    $this->addErro("FALHA AO EXECUTAR OPERA??O, VE?CULO N?O EM BAIXA!");
                }
    ...
    public function rotaAction() {
        ...
        if ($id) {
            ...
            if ($transporte) {
                ...
                $this->view->registros = $tb->listar_por_pagina(array("id_transporte" => $transporte->getId(), "pagina_atual" => $page));
                $button = Escola_Button::getInstance();
                $button->setTitulo("CADASTRO DE TR?NSITO > ROTAS");
                $button->addFromArray(array("titulo" => "Adicionar",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "editarrota",
                    "img" => "icon-plus-sign",
                    ...
                    if (isset($dados["dia_tipo"]) && is_array($dados["dia_tipo"]) && count($dados["dia_tipo"])) {
                        foreach ($dts as $dt) {
                            if (isset($dados["dia_tipo"][$dt->getId()])) {
                                ...
                                throw new Exception("FALHA AO EXECUTAR OPERA??O, NENHUMA INFORMA??O PARA O DIA: " . $dt->toString());
                            }
                        }
                    } else {
            ...
            if ($registro) {
                ...
                if (!$errors) {
                    ...
                    if ($flag) {
                        ...
                        $this->addErro("FALHA AO EXECUTAR OPERA??O, CHAME O ADMINISTRADOR!");
                    }
                } else {
                    foreach ($errors as $erro) {
                        $this->_flashMessage($erro);
    ...
    public function rotaviagemAction() {
        ...
        if ($id) {
            ...
            if ($rota) {
                ...
                $button = Escola_Button::getInstance();
                $button->setTitulo("CADASTRO DE TR?NSITO > ROTAS > SA?DAS");
                $button->addFromArray(array("titulo" => "Voltar",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "rota",
                    "img" => "icon-reply",
    ...
    public function bdoAction() {
        ...
        if ($id) {
            ...
            if ($rota) {
                ...
                $this->view->dados = $dados;
                $button = Escola_Button::getInstance();
                $button->setTitulo("CADASTRO DE TR?NSITO > ROTAS > BOLETIM DI?RIO DE ?NIBUS");
                $button->addFromArray(array("titulo" => "Adicionar",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "editarbdo",
                    "img" => "icon-plus-sign",
    ...
    public function editarbdoAction() {
        ...
        if (!$tvs || !count($tvs)) {
            $this->addErro("FALHA AO EXECUTAR OPERA??O, NENHUM VE?CULO ATIVO DISPON?VEL!");
        ...
        if (!$tarifas || !count($tarifas)) {
            $this->addErro("FALHA AO EXECUTAR OPERA??O, NENHUMA TARIFA DISPON?VEL!");
            $this->_redirect($this->_request->getControllerName() . "/bdo/id/0");
            die();
        }
                        ...
                        if ($tts && count($tts)) {
                            ...
                            foreach ($tts as $tt) {
                                if (isset($dados["passageiros"][$tt->getId()]) && $dados["passageiros"][$tt->getId()]) {
                                    ...
                                    throw new Exception("CAMPO PASSAGEIROS INV?LIDO PARA O TIPO: " . $tt->toString());
                                }
                            }
                        }
                    } else {
                        throw new Exception("FALHA AO EXECUTAR OPERA??O, CHAME O ADMINISTRADOR!");
                    }
                }
                $db->commit();
                $this->_flashMessage("REGISTRO SALVO COM SUCESSO!", "Messages");
...
//        $this->view->tarifas = $tarifas;
        $button = Escola_Button::getInstance();
        if ($this->view->registro->getId()) {
            $button->setTitulo("CADASTRO DE TRANSPORTES > ROTA > BOLETIM DI?RIO DE ?NIBUS- ALTERAR");
        } else {
            $button->setTitulo("CADASTRO DE TRANSPORTES > ROTA > BOLETIM DI?RIO DE ?NIBUS - INSERIR");
        }
        $button->addScript("Salvar", "salvarFormulario('formulario')", "icon-save");
        $button->addFromArray(array("titulo" => "Voltar",
            "controller" => $this->_request->getControllerName(),
    ...
    public function rotaparadaAction() {
        ...
        if ($id) {
            ...
            if ($rota) {
                ...
                $this->view->registros = $tb->listar_por_pagina(array("id_rota" => $rota->getId(), "pagina_atual" => $page));
                $button = Escola_Button::getInstance();
                $button->setTitulo("CADASTRO DE TR?NSITO > ROTAS > PONTOS DE ?NIBUS");
                $button->addFromArray(array("titulo" => "Adicionar",
                    "controller" => $this->_request->getControllerName(),
                    "action" => "editarparada",
                    "img" => "icon-plus-sign",
    ...
    public function editarparadaAction() {
        ...
        $ops = $tb->listar();
        if (!$ops || !count($ops)) {
            $this->addErro("FALHA AO EXECUTAR OPERA??O, NENHUM PONTO DE ?NIBUS CADASTRADO!");
        ...
        $button = Escola_Button::getInstance();
        if ($this->view->registro->getId()) {
            $button->setTitulo("CADASTRO DE TRANSPORTES > ROTA > PONTO DE ?NIBUS- ALTERAR");
        } else {
            $button->setTitulo("CADASTRO DE TRANSPORTES > ROTA > PONTO DE ?NIBUS - INSERIR");
        }
        $button->addScript("Salvar", "salvarFormulario('formulario')", "icon-save");
        $button->addFromArray(array("titulo" => "Voltar",
            "controller" => $this->_request->getControllerName(),
    ...
    public function viewparadaAction() {
        ...
        if ($id) {
            ...
            if ($registro) {
                ...
                $button = Escola_Button::getInstance();
                $button->setTitulo("VISUALIZAR TRANSPORTE > ROTA > PONTO DE ?NIBUS");
    ...
    public function ativarAction() {
        try {
            $id = $this->_request->getParam("id");
            if (!$id) {
                throw new Exception("Falha ao Executar Opera??o, Pessoa N?o Localizada!");
            }
            ...
            if (!$tpt) {
                throw new Exception("Falha ao Executar Opera??o, Tipo de Pessoa N?o Encontrado!");
            }

            if (!$tpt->proprietario()) {
                throw new Exception("Falha ao Executar Opera??o, Pessoa N?o ? Permission?rio!");
            }

            if ($tp->ativo()) {
                throw new Exception("Falha ao Executar Opera??o, Pessoa J? Est? Ativa!");
            }
    ...
    public function licencaeditarAction() {
        try {
            $id = $this->_request->getParam("id");
            if (!$id) {
                throw new Exception("Falha ao Executar Opera??o, Solicita??o de Servi?o N?o Localizada!");
            }
            ...
            if ($ss->pago()) {
                throw new Exception("Falha ao Executar Opera??o, Solicita??o de Servi?o J? Paga!");
            }
            ...
            $stg = $ss->findParentRow("TbServicoTransporteGrupo");
            if (!$stg) {
                throw new Exception("Falha, Nenhum Servi?o Dispon?vel!");
            }
            $tg = $stg->findParentRow("TbTransporteGrupo");
            if (!$tg) {
                throw new Exception("Falha, Nenhum Grupo de Transporte Dispon?vel!");
            }
            $stgs = $tb->listar(
                    array(
            ...
            $button = Escola_Button::getInstance();
            $button->setTitulo("ALTERA??O DE SOLICITA??O DE SERVI?O!");
            $button->addScript("Salvar", "salvarFormulario('formulario')", "icon-save");
            $button->addFromArray(array("titulo" => "Voltar",
                "controller" => $this->_request->getControllerName(),
                "action" => "licenca",
    ...
    public function licencacancelarAction() {
        ...
        try {
            if (!$id) {
                throw new Exception("Falha ao Executar Opera??o, Nenhum Registro Localizado!");
            }
            $ss = TbServicoSolicitacao::pegaPorId($id);
            if (!$ss) {
                throw new Exception("Falha ao Executar Opera??o, Nenhum Registro Localizado!");
            ...
            if (!$ss->aguardando_pagamento()) {
                throw new Exception("Falha ao Executar Opera??o, Status Inv?lido para Cancelamento!");
            }
            $ss->cancelar();
