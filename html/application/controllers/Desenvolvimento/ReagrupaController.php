        ...
        try {
            ...
            $sql = "
                select tg.id_transporte_grupo, tg.descricao as transporte_grupo,
                    ...
                    pj.cnpj, pj.nome_fantasia as pj_nome,
                ...
                group by pf.cpf, pf.nome, pj.cnpj, pj.nome_fantasia, tg.id_transporte_grupo, tg.descricao
            ...
            foreach ($objs as $obj) {
                ...
                $transportes = Escola_DbUtil::listar("
                    ...
                    from transporte_pessoa tp
                        ...
                        left outer join transporte_veiculo tv on t.id_transporte = tv.id_transporte
                    where (tp.id_transporte_pessoa_status = 1)
                    and (tp.id_transporte_pessoa_tipo = 1)
                    and (tv.id_transporte_veiculo_status = 1)
                ...
                ", [$obj->id_transporte_grupo, $obj->id_pessoa]);
