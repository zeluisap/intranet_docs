...
class Desenvolvimento_DividirCargaController extends Escola_Controller_Logado
{
    ...
    public function dividir_carga()
    {
        ...
        try {
            ...
            foreach ($transportes as $transporte) {
                ...
                Escola_Util::log([$qtd, number_format($percentual, 2) . "%", $transporte->codigo, $transporte->pf_nome, $transporte->pj_nome]);
    ...
    private function migrar_servicos($ids, $id_carga_pj)
    {
        ...
        foreach ($objs as $obj) {
            ...
            $id_stg_destino = $controller->copiarServico($obj, $id_carga_pj);
            ...
            Escola_DbUtil::query("
                ...
                ", [$id_stg_destino, $obj->id_servico_transporte_grupo]);
        }
    }
