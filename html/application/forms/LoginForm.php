...
class LoginForm extends Zend_Form {
	...
	public function init() {
		...
		$cpf->addValidator("NotEmpty", true, array("messages" => utf8_encode("CAMPO OBRIGATÓRIO!")));
		$cpf->addValidator("alnum", false, array("messages" => utf8_encode("NUMERO DE CPF INVALIDO!")));
		...
		$senha->addValidator("NotEmpty", true, array("messages" => utf8_encode("CAMPO OBRIGATÓRIO!")));
