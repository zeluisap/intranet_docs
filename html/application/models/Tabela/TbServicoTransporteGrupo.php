...
class TbServicoTransporteGrupo extends Escola_Tabela {
	...
	protected $_referenceMap = array("Servico" => array("columns" => array("id_servico"),
												   "refTableClass" => "TbServico",
												   "refColumns" => array("id_servico")),
                                     "TransporteGrupo" => array("columns" => array("id_transporte_grupo"),
                                     ...
                                     "Periodicidade" => array("columns" => array("id_periodicidade"),
    ...
    public function getSql($dados = array()) {
        ...
        $sql->order("stg.id_servico_transporte_grupo");
        return $sql;
    }
}