...
class TbServicoSolicitacao extends Escola_Tabela {
    ...
    protected $_referenceMap = array("ServicoSolicitacaoStatus" => array("columns" => array("id_servico_solicitacao_status"),
												   "refTableClass" => "TbServicoSolicitacaoStatus",
												   "refColumns" => array("id_servico_solicitacao_status")),
                                     "ServicoTransporteGrupo" => array("columns" => array("id_servico_transporte_grupo"),
