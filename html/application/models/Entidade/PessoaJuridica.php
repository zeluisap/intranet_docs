...
class PessoaJuridica extends Escola_Entidade {
    ...
    public function render(Zend_View_Interface $view) {
        ...
        <div class="form-group">
            ...
            <input type="text" name="cnpj" id="cnpj" class="form-control" value="<?php echo Escola_Util::formatCnpj($this->cnpj); ?>" size="20" />
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-group">
            <label for="sigla">Sigla:</label>
            <input type="text" name="sigla" id="sigla" class="form-control nome" value="<?php echo $this->sigla; ?>" size="20" />
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-group">
            <label for="razao_social">Razão Social:</label>
            <input type="text" name="razao_social" id="razao_social" class="form-control" value="<?php echo $this->razao_social; ?>" size="60" />
        </div>
        </div>
        <div class="col-md-4">
        <div class="form-group">
            <label for="nome_fantasia">Nome Fantasia:</label>
            <input type="text" name="nome_fantasia" id="nome_fantasia" class="form-control" value="<?php echo $this->nome_fantasia; ?>" size="60" />
        </div>
        </div>
        <?php
        $html = ob_get_contents();
