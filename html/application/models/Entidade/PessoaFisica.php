...
?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="nome" id="nome" class="form-control nome" value="<?php echo $this->nome; ?>" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nome_pai" id="nome_pai" class="form-control nome" value="<?php echo $this->nome_pai; ?>" />
        </div>
        <div class="form-group">
            <label for="nome_mae">Nome da Mãe:</label>
            <input type="text" name="nome_mae" id="nome_mae" class="form-control nome" value="<?php echo $this->nome_mae; ?>" />
        </div>
<?php
...
?>	
        <div class="form-group">
            ...
            <input type="text" name="identidade_numero" id="identidade_numero" class="form-control" value="<?php echo $this->identidade_numero; ?>" size="30" />
        </div>
        <div class="form-group">
            <label for="identidade_orgao_expedidor">Identidade - Órgão Emissor:</label>
            <input type="text" name="identidade_orgao_expedidor" id="identidade_orgao_expedidor" class="form-control" value="<?php echo $this->identidade_orgao_expedidor; ?>" size="20" />
        </div>
<?php
...
?>
        <div class="form-group">
            ...
            <input type="text" name="pis_pasep" id="pis_pasep" class="form-control" value="<?php echo $this->pis_pasep; ?>" size="11" />
        </div>
<?php
        $html = ob_get_contents();
        ob_end_clean();
