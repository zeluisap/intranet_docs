            ...
            if ($anexos) {
                ...
                <table border="1" cellpadding="5" class="grade">
                    ...
                    foreach ($anexos as $anexo) {
                        ...
                        ?>
                        <tr>
                            <td><div align="left"><?php echo $doc->findParentRow("TbDocumentoTipo")->toString(); ?></div></td>
                            <td><div align="left"><?php echo $doc->mostrarNumero(); ?></div></td>
                            <td><div align="left"><?php echo $doc->mostrarInteressado(); ?></div></td>
                            <td><div align="left"><?php echo $doc->resumo; ?></div></td>
                            <td><div align="left"><?php echo $anexo->mostrarTipo(); ?></div></td>
                        </tr>
                <?php } ?>
                </table>
            <?php } ?>
