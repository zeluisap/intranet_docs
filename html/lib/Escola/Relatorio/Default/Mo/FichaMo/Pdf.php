        ...
        if ($sistema) {
            ...
            <?php } ?>
                ...
                if ($endereco) {
                    ...
                    ?>
                    <tr><td><?php echo $endereco1; ?></td></tr>
                    <tr><td><?php echo $endereco2; ?></td></tr>
                    <tr><td><?php echo $endereco3; ?></td></tr>
            <?php }
            ?>
            </table>
            <br />
        ...
        <table border="1" cellpadding="5">
            ...
            <tbody>
                <tr>
                    <td width="300px">
                        <table>
                            <tr><td class="rotulo">Grupo de Transporte:</td></tr>
                            <tr><td class="info"><?php echo $txt_gt; ?></td></tr>
                        </table>
                    </td>
                    <td width="100px">
                        <table>
                            <tr><td class="rotulo">Matrícula</td></tr>
                            <tr><td class="info"><?php echo $txt_matricula; ?></td></tr>
                        </table>
                    </td>
                    <td colspan="2" width="273px">
                        <table>
                            <tr><td class="rotulo">Nome:</td></tr>
                            <tr><td class="info"><?php echo $txt_nome; ?></td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td rowspan="2" colspan="2">
                        <table>
                            <tr><td class="rotulo">Endereço:</td></tr>
                            <tr><td class="info"><?php echo $txt_endereco; ?></td></tr>
                        </table>
                    </td>
                    <td>
                        <table>
                            <tr><td class="rotulo">Bairro:</td></tr>
                            <tr><td class="info"><?php echo $txt_bairro; ?></td></tr>
                        </table>
                    </td>
                    <td>
                        <table>
                            <tr><td class="rotulo">CEP:</td></tr>
                            <tr><td class="info"><?php echo $txt_cep; ?></td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table>
                            <tr><td class="rotulo">Celular:</td></tr>
                            <tr><td class="info"><?php echo $txt_celular; ?></td></tr>
                        </table>
                    </td>
                    <td>
                        <table>
                            <tr><td class="rotulo">Fone Residencial:</td></tr>
                            <tr><td class="info"><?php echo $txt_fone; ?></td></tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table>
                            <tr><td class="rotulo">C.P.F.:</td></tr>
                            <tr><td class="info"><?php echo $txt_cpf; ?></td></tr>
                        </table>
                    </td>
                    <td colspan="2">
                        <table>
                            <tr><td class="rotulo">R.G.:</td></tr>
                            <tr><td class="info"><?php echo $txt_rg; ?></td></tr>
                        </table>
                    </td>
                    <td>
                        <table>
                            <tr><td class="rotulo">Data Cadastro:</td></tr>
                            <tr><td class="info"><?php echo $txt_data_cadastro; ?></td></tr>
                        </table>
                    </td>
                </tr>
            </tbody>
        ...
        <table border="1"  cellpadding="5">
            ...
            <tbody>
                <tr>
                    <td>
                        <table>
                            <tr><td class="rotulo">Categoria:</td></tr>
                            <tr><td class="info"><?php echo $txt_cnh_categoria; ?></td></tr>
                        </table>
                    </td>
                    <td>
                        <table>
                            <tr><td class="rotulo">Número:</td></tr>
                            <tr><td class="info"><?php echo $txt_cnh_numero; ?></td></tr>
                        </table>
                    </td>
                    <td>
                        <table>
                            <tr><td class="rotulo">Validade:</td></tr>
                            <tr><td class="info"><?php echo $txt_cnh_validade; ?></td></tr>
                        </table>                
                    </td>
                </tr>
            </tbody>
