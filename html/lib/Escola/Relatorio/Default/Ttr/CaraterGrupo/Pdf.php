...
class Escola_Relatorio_Default_Ttr_CaraterGrupo_Pdf extends Escola_Relatorio {
            ...
            if ($stmt && $stmt->rowCount()) {
                ...
                while ($obj = $stmt->fetch(Zend_Db::FETCH_OBJ)) {
                    if ($id_concessao_tipo != $obj->id_concessao_tipo) {
                        ...
                        ?>
                        <tr>
                            <th colspan="10"><?php echo $obj->concessao_tipo_descricao; ?></th>
                        </tr>
                        <tr>
                    ...
                    ?>
                    <tr>
                        <td align="center"><div class="text-center"><?php echo $transporte->codigo; ?></div></td>
                        <td><?php echo $proprietario_txt; ?></td>
                        <td align="center"><div class="text-center"><?php echo $obj->decreto; ?></div></td>
                        <td align="center"><div class="text-center"><?php echo Escola_Util::formatData($obj->concessao_data); ?></div></td>
                        <td align="center"><div class="text-center"><?php echo $data_cadastro; ?></div></td>
                        <td align="center"><div class="text-center"><?php echo $txt_modelo; ?></div></td>
                        <td align="center"><div class="text-center"><?php echo $ano; ?></div></td>
                        <td align="center"><div class="text-center"><?php echo $veiculo_txt; ?></div></td>
                        <td align="center"><div class="text-center"><?php echo $licenca_data; ?></div></td>
                        <td align="center"><div class="text-center"><?php echo $licenca_validade; ?></div></td>
                    </tr>
                <?php } ?>
            <?php } else { ?>
                <tr>
