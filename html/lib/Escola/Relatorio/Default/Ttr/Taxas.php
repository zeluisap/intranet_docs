<?php
class Escola_Relatorio_Default_Ttr_Taxas extends Escola_Relatorio_Default {
	...
	public function toXLS() {
        ...
        public function pegaStatement() {
            ...
            $sql->join(array("s" => "servico"), "stg.id_servico = s.id_servico", array("s.id_servico", "servico_descricao" => "s.descricao" ));
            ...
            $sql->group("s.descricao");
            $sql->group("s.id_servico");
            return $db->query($sql);
        }
...
<?php }
    ...
    ?>
            <tr>
                <td><div class="text-center"><?php echo Escola_Util::formatData($obj->data_pagamento); ?></div></td>
                <td><?php echo $obj->servico_descricao; ?></td>
...
<?php foreach ($resumo as $item_resumo) { ?>
            <tr>
                ...
                <td><div class="text-center"><?php echo Escola_Util::number_format($item_resumo->valor); ?></div></td>
            </tr>
