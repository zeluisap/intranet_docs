...
?>
        <tr>
            <td><div class="text-center"><?php echo $motorista->matricula; ?></div></td>
            <td><div class="text-center"><?php echo $cpf; ?></div></td>
            <td><div class="text-left"><?php echo $nome; ?></div></td>
            <td><div class="text-center"><?php echo $data_cadastro; ?></div></td>
            <td><div class="text-center"><?php echo $cnh_numero; ?></div></td>
            <td><div class="text-center"><?php echo $cnh_validade; ?></div></td>
            <td><div class="text-center"><?php echo $cnh_categoria; ?></div></td>
            <td><div class="text-center"><?php echo $carteira_numero; ?></div></td>
            <td><div class="text-center"><?php echo $carteira_validade; ?></div></td>
        </tr>
<?php } ?>
<?php } else { ?>
    <tbody>
        <tr>
            <td colspan="5"><div class="text-center">NENHUM REGISTRO LOCALIZADO!</div></td>
        </tr>
<?php } ?>
    </tbody>
</table>
