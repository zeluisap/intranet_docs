...
class Escola_Relatorio_Default_Ttr_Taxasapagar_Pdf extends Escola_Relatorio {
        ...
        if ($stmt && $stmt->rowCount()) {
            ...
            <table border="1" cellpadding="5">
                ...
                while ($obj = $stmt->fetch(Zend_Db::FETCH_OBJ)) {
                    ...
                    ?>
                    <tr class="grade">
                        <td align="center" width="20%"><div><?php echo Escola_Util::formatData($obj->data_vencimento); ?></div></td>
