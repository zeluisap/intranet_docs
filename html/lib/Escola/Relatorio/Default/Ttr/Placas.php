...
?>
        <tr>
            <td><div class="text-center"><?php echo $veiculo->placa; ?></div></td>
            <td><div class="text-center"><?php echo $transporte->findParentRow("TbTransporteGrupo")->toString(); ?></div></td>
            <td><div class="text-center"><?php echo $transporte->codigo; ?></div></td>
            <td><?php echo $proprietario_txt; ?></td>
            <td><div class="text-center"><?php echo $veiculo->ano_fabricacao; ?></div></td>
            <td><div class="text-center"><?php echo Escola_Util::formatData($tb->baixa_data); ?></div></td>
            <td><div class="text-center"><?php echo $veiculo->chassi; ?></div></td>
            <td><div class="text-center"><?php echo $veiculo->findParentRow("TbFabricante")->toString(); ?></div></td>
            <td><div class="text-center"><?php echo $veiculo->modelo; ?></div></td>
            <td><div class="text-center"><?php echo $veiculo->findParentRow("TbCor")->toString(); ?></div></td>
        </tr>
<?php } ?>
<?php } else { ?>
        <tr>
            <td colspan="10"><div class="text-center">NENHUM REGISTRO LOCALIZADO!</div></td>
        </tr>
<?php } ?>
    </tbody>
</table>
