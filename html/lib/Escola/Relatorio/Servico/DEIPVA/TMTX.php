...
class Escola_Relatorio_Servico_DEIPVA_TMTX extends Escola_Relatorio_Servico {
    ...
    public function toPDF() {
        ...
        <p></p><p></p>
        <div class="paragrafo">A <?php echo $pj->razao_social; ?>-<?php echo $pj->sigla; ?>, autarquia municipal de regime especial, criada através da Lei No.: 434/1999, inscrita no CNPJ/SRFB/MF sob o No.: <?php echo $pj->mostrar_documento(); ?>, Órgão Executivo Municipal de Transportes e Trânsito declara para os fins de direito, que o veículo abaixo individuado, encontra-se registrado no Cadastro de Veículos de Aluguel na Categoria Transporte Individual de Passageiros (Moto-Taxi), vinculado à Permissão <?php echo $transporte->mostrar_codigo(); ?> de titularidade do(a) Sr(a). <?php echo $proprietario_pf->mostrar_nome(); ?> outorgada através do Decreto No.: <?php echo $concessao->decreto; ?>, em carater <?php echo $concessao->findParentRow("TbConcessaoTipo")->toString(); ?>.</div>
