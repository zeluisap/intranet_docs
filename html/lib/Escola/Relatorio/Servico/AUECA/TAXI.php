...
class Escola_Relatorio_Servico_AUECA_TAXI extends Escola_Relatorio_Servico {
    ...
    public function validarEmitir() {
        ...
        if (!$transporte) {
            ...
            if (!$veiculo) {
                ...
                if ($veiculo->retido()) {
                    $errors[] = "VEÍCULO VINCULADO AO TRANSPORTE ENCONTRA-SE RETIDO AO PÁTION DA STTRANS!";
                }
            }
        }
        if ($p_errors) {
