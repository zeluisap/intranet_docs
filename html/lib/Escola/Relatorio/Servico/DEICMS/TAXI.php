...
class Escola_Relatorio_Servico_DEICMS_TAXI extends Escola_Relatorio_Servico {

    public function __construct() {
        parent::__construct();
        $this->setFilename("declaracao_isencao_icms");
    ...
    public function toPDF() {
        ...
        <p></p>
        <div class="negrito">Assunto: Isenção de I.C.M.S.</div>
        <p></p>
