...
class Escola_Relatorio_Servico_AMCP extends Escola_Relatorio_Servico {

    public function __construct() {
        parent::__construct();
        $this->setFilename("autorizacao_mudanca_categoria_particular");
    ...
    public function toPDF() {
        ...
        <div class="paragrafo">A <?php echo $pj->sigla; ?>-<?php echo $pj->mostrar_nome(); ?>, através desta autoriza o detentor da Permissão de Serviço <?php echo $tg->toString(); ?> a executar junto ao DETRAN-AP, o serviço de:<br />
            <span class="negrito font_14pt">* MUDANÇA DE CATEGORIA PARA PARTICULAR</span> do veículo abaixo:</div>
