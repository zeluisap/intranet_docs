...
class Escola_Relatorio_Servico_CM_MO_CARGA extends Escola_Relatorio_Servico {
    ...
    public function imprimir() {
        ...
        $this->setXY(15, 81.5);
        //$this->MultiCell(100, 20, "LICENÇA DE CONDUTOR No.: {$licenca->codigo}/{$licenca->ano_referencia}", 0, 'C');
