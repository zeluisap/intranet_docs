...
class Escola_Relatorio_Servico_CM_MO_TAXI extends Escola_Relatorio_Servico {
    ...
    public function imprimir() {
        ...
        $this->setXY(15, 81.5);
        //$this->MultiCell(100, 20, utf8_encode("LICENÇA DE CONDUTOR No.: {$licenca->codigo}/{$licenca->ano_referencia}"), 0, 'C');
        $this->MultiCell(100, 20, utf8_encode("LICENÇA DE CONDUTOR No.: {$ss->codigo}/{$ss->ano_referencia}"), 0, 'C');
        ...
        $this->setXY(17, 122);
        $this->MultiCell(100, 20, utf8_encode("O portador encontra-se cadastrado na STTRANS, para o serviço de Táxi."), 0, 'L');
