<?php
class Escola_Relatorio_Servico_LT_TAXI extends Escola_Relatorio_Servico {
    
    public function __construct() {
        parent::__construct();

        $this->setFilename("relatorio_licenca_taxi_" . date("YmdHis"));
    }
    ...
    public function imprimir() {
        ...
        $this->setXY(15, 81.5);
        $this->MultiCell(100, 20, utf8_encode("CERTIFICADO PARA TRAFEGAR No.: {$licenca->codigo}/{$licenca->ano_referencia}"), 0, 'C');
