...
class Escola_Relatorio_Servico_APCA extends Escola_Relatorio_Servico {

    public function __construct() {
        parent::__construct();
        $this->setFilename("autorizacao_permanencia_categoria_aluguel");
    ...
    public function toPDF() {
        ...
        <div class="paragrafo">A <?php echo $pj->sigla; ?>-<?php echo $pj->mostrar_nome(); ?>, através desta autoriza o detentor da Permissão de Serviço <?php echo $tg->toString(); ?>, acima qualificado e inscrito nesta <?php echo $pj->sigla; ?> sob a matrícula <?php echo $transporte->mostrar_codigo(); ?> a executar junto ao DETRAN-AP, o serviço de:<br />
            <span class="negrito font_14pt">* PERMANÊNCIA NA CATEGORIA ALUGUEL</span> do veículo abaixo:</div>
