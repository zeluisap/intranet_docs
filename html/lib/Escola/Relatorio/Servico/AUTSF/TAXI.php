...
class Escola_Relatorio_Servico_AUTSF_TAXI extends Escola_Relatorio_Servico {

    public function __construct() {
        parent::__construct();
        $this->setFilename("autorizacao_trafego_sem_faixa");
...
<?php } ?>
        ...
        <div class="paragrafo">A <?php echo $pj->sigla; ?>-<?php echo $pj->mostrar_nome(); ?>, atraves desta autorização o Detentor da Permissão de Execução de Serviço de Transporte Individual de Passageiros, acima qualificado e inscrito nesta <?php echo $pj->sigla; ?> a trafegar sem a faixa característica de táxi do Município de Santana até o dia <?php echo Escola_Util::formatData($this->registro->data_validade); ?>.</div>
        <div></div><div></div>
