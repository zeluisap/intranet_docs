...
class Escola_Relatorio_Servico_CP_PR_CARGA extends Escola_Relatorio_Servico {
    ...
    public function __construct($tr = null) {
        ...
        $this->setFilename("relatorio_carteira_carga_permissionario_" . date("YmdHis"));
    }
    ...
    public function imprimir() {
        ...
        $this->setXY(49, 33);
        $this->MultiCell(60, 10, utf8_encode($txt_transporte), 0, 'C', 0, 0, '', '', true, 0, false, true, 10, 'M');
        ...
        $this->setXY(15, 81.5);
        $this->MultiCell(100, 20, utf8_encode("AUTORIZAÇÃO DE TRÁFEGO No.: {$licenca->codigo}/{$licenca->ano_referencia}"), 0, 'C');

        $this->setFont($font_name, "B", 10);
        $this->setXY(15, 85);
        $this->MultiCell(100, 20, utf8_encode("PERMISSÃO {$transporte->codigo}"), 0, 'C');
        ...
        $this->setXY(17, 122);
        $this->MultiCell(100, 20, utf8_encode("O portador encontra-se cadastrado na STTRANS, para o serviço de Transporte de Carga."), 0, 'L');
