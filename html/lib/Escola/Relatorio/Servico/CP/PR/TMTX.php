...
class Escola_Relatorio_Servico_CP_PR_TMTX extends Escola_Relatorio_Servico {
    ...
    public function __construct($tr) {
        ...
        $this->setFilename("relatorio_carteira_mototaxi_permissionario_" . date("YmdHis"));
    }
    ...
    public function imprimir() {
        ...
        $this->setXY(17, 122);
        $this->MultiCell(100, 20, utf8_encode("O portador encontra-se cadastrado na STTRANS, para o serviço de Mototáxi."), 0, 'L');
