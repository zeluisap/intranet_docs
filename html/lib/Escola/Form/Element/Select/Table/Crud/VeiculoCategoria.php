<?php
class Escola_Form_Element_Select_Table_Crud_VeiculoCategoria extends Escola_Form_Element_Select_Table_Crud {
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#janela_crud_<?php echo $this->getName(); ?> #bt_crud_submit").click(function() {
            ajax = $.ajax({
                "url" : "<?php echo $view->baseUrl(); ?>/veiculocategoria/salvar/format/json/",
                "type" : "POST",
	...
	function reloadCrud_<?php echo $this->getName(); ?>(default_id) {
        ajax = $.ajax({
            "url" : "<?php echo $view->baseUrl(); ?>/veiculocategoria/listar/format/json/",
            "type" : "POST",
            "success" : function(obj_view) {
                if (obj_view.result) {
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Adicionando Registro - Categoria de Veículo</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="descricao" id="" maxlength="50" class="crud_cadastro form-control" />
                        </div>
                    </div>
