<?php
class Escola_Form_Element_Select_Table_Crud_Fabricante extends Escola_Form_Element_Select_Table_Crud {
...
<div id="janela_crud_<?php echo $this->getName(); ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Adicionando Registro - Fabricante</h4>
    </div>
