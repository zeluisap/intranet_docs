	...
	$(document).ready(function() {
		$("#janela_crud_<?php echo $this->getName(); ?> #bt_crud_submit").click(function() {
            ajax = $.ajax({
                ...
                "type" : "POST",
                "data" : { "descricao" : $("#janela_crud_<?php echo $this->getName(); ?> #descricao").val(), "id_uf": $("#<?php echo $this->_id_uf; ?>").val() },
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 id="myModalLabel" class="modal-title">Adicionando Registro - Município</h4>
            </div>
