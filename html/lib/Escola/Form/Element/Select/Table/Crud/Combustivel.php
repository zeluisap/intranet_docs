<?php
class Escola_Form_Element_Select_Table_Crud_Combustivel extends Escola_Form_Element_Select_Table_Crud {
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#janela_crud_<?php echo $this->getName(); ?> #bt_crud_submit").click(function() {
            ajax = $.ajax({
                "url" : "<?php echo $view->baseUrl(); ?>/combustivel/salvar/format/json/",
                "type" : "POST",
	...
	function reloadCrud_<?php echo $this->getName(); ?>(default_id) {
        ajax = $.ajax({
            "url" : "<?php echo $view->baseUrl(); ?>/combustivel/listar/format/json/",
            "type" : "POST",
            "success" : function(obj_view) {
                if (obj_view.result) {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Adicionando Registro - Combustível</h4>
            </div>
