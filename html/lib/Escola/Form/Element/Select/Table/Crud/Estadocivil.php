<?php
class Escola_Form_Element_Select_Table_Crud_Estadocivil extends Escola_Form_Element_Select_Table_Crud {
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#janela_crud_<?php echo $this->getName(); ?> #bt_crud_submit").click(function() {
            ajax = $.ajax({
                "url" : "<?php echo $view->baseUrl(); ?>/estadocivil/salvar/format/json/",
                "type" : "POST",
	...
	function reloadCrud_<?php echo $this->getName(); ?>(default_id) {
        ajax = $.ajax({
            "url" : "<?php echo $view->baseUrl(); ?>/estadocivil/listar/format/json/",
            "type" : "POST",
            "success" : function(obj_view) {
                if (obj_view.result) {
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 id="myModalLabel" class="modal-title">Adicionando Registro - Estado Civil</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="descricao" id="descricao" class="crud_cadastro form-control" />
                </div>
            </div>
