...
class Escola_Form_Element_Select_Table_PessoaFisica extends Escola_Form_Element_Select_Table {
    ...
    public function render(Zend_View_Interface $view = null) {
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h3 class="modal-title" id="myModalLabel">Pessoa Física</h3>
                    </div>
        ...
        <?php if ($this->hab_adicionar) { ?>
            <div id="janela_cpf_<?php echo $this->getName(); ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h3 class="modal-title" id="myModalLabel">Pessoa Física - Informe o C.P.F.</h3>
                </div>
                <div class="modal-body">
                    <div class="alert">
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <input type="text" name="<?php echo $this->getName(); ?>_add_cpf" id="<?php echo $this->getName(); ?>_add_cpf" class="field form-control cpf" />
                        </div>
                    </fieldset>
                </div>
                <div class="modal-footer">
            ...
            <div id="janela_add_<?php echo $this->getName(); ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h3 class="modal-title" id="myModalLabel">Pessoa Física - Adicionar</h3>
                </div>
                <div class="modal-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="<?php echo $this->getName(); ?>_add_nome" id="<?php echo $this->getName(); ?>_add_nome" class="field form-control"  />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_email" class="control-label">E-Mail:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_email" id="<?php echo $this->getName(); ?>_add_email" class="field form-control"  />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <?php
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="<?php echo $this->getName(); ?>_add_data_nascimento" id="<?php echo $this->getName(); ?>_add_data_nascimento" class="field form-control data"  />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_nome_pai" class="control-label">Nome do Pai:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_nome_pai" id="<?php echo $this->getName(); ?>_add_nome_pai" class="field form-control"  />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_nome_mae" class="control-label">Nome da Mãe:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_nome_mae" id="<?php echo $this->getName(); ?>_add_nome_mae" class="field form-control"  />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_identidade_numero" class="control-label">RG - Número:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_identidade_numero" id="<?php echo $this->getName(); ?>_add_identidade_numero" size="30" maxlength="30" value="" class="field form-control" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_identidade_orgao_expedidor" class="control-label">RG - Órgão Expedidor:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_identidade_orgao_expedidor" id="<?php echo $this->getName(); ?>_add_identidade_orgao_expedidor" size="20" maxlength="20" value="" class="field form-control" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <?php
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="<?php echo $this->getName(); ?>_add_telefone_fixo" id="<?php echo $this->getName(); ?>_add_telefone_fixo" class="form-control telefone field" value="" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_telefone_celular" class="control-label">Telefone Celular:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_telefone_celular" id="<?php echo $this->getName(); ?>_add_telefone_celular" class="form-control telefone field" value="" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_logradouro" class="control-label">Logradouro:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_logradouro" id="<?php echo $this->getName(); ?>_add_logradouro" class="form-control field" maxlength="60" value="" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_numero" class="control-label">Número:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_numero" id="<?php echo $this->getName(); ?>_add_numero" class="form-control field" value="" maxlength="10" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_complemento" class="control-label">Complemento:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_complemento" id="<?php echo $this->getName(); ?>_add_complemento" class="form-control field" maxlength="40" value="" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="<?php echo $this->getName(); ?>_add_cep" class="control-label">C.E.P.:</label>
                            <input type="text" name="<?php echo $this->getName(); ?>_add_cep" id="<?php echo $this->getName(); ?>_add_cep" class="form-control cep field" value="" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <?php
        ...
        <div class="input-group" id="linha_<?php echo $this->getName(); ?>">
            ...
            if ($this->hab_adicionar) {
                ?>
                <span class="input-group-btn <?php echo $this->getName(); ?>_bt_alterar" <?php echo $style; ?>>
                    <a href="#" class="link_alterar_<?php echo $this->getName(); ?> btn btn-white">
                        <i class="icon-cog"></i>
                    </a>
                </span>
            <?php } ?>
            <span class="input-group-btn <?php echo $this->getName(); ?>_bt_cancelar " <?php echo $style; ?>>
                <a href="#" class="link_cancelar_<?php echo $this->getName(); ?> btn btn-white">
