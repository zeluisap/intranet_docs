...
$dadosboleto["inicio_nosso_numero"] = date("y");	// Ano da geraÃÂ§ÃÂ£o do tÃÂ­tulo ex: 07 para 2007 
$dadosboleto["nosso_numero"] = "13871";  			// Nosso numero (mÃÂ¡x. 5 digitos) - Numero sequencial de controle.
...
$dadosboleto["aceite"] = "N";	    // N - remeter cobranÃÂ§a sem aceite do sacado  (cobranÃÂ§as nÃÂ£o-registradas)
                                  // S - remeter cobranÃÂ§a apos aceite do sacado (cobranÃÂ§as registradas)
$dadosboleto["especie"] = "R$";
$dadosboleto["especie_doc"] = "A"; // OS - Outros segundo manual para cedentes de cobranÃÂ§a SICREDI
...
$dadosboleto["posto"]= "18";      // CÃÂ³digo do posto da cooperativa de crÃÂ©dito
$dadosboleto["byte_idt"]= "2";	  // Byte de identificaÃÂ§ÃÂ£o do cedente do bloqueto utilizado para compor o nosso nÃÂºmero.
                                  // 1 - Idtf emitente: Cooperativa | 2 a 9 - Idtf emitente: Cedente
$dadosboleto["carteira"] = "A";   // CÃÂ³digo da Carteira: A (Simples) 
