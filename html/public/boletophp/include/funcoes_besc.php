...
// nÃÂºmero do documento (sem dvs) ÃÂ© 13 digitos
$nnum = formata_numero($dadosboleto["nosso_numero"],13,0);
// nosso nÃÂºmero (com dvs) ÃÂ© 16 digitos
...
// Digitos Verificadores da Chave de 25 posiÃÂ§ÃÂµes
$dv1 = m10dv1($chave);
...
//DÃÂGITOS   VERIFICADORES  DA  CHAVE  DE   25 POSIÃÂÃÂES - Digito V1
function m10dv1($num)
{
	$soma = 0; $fator = 2;
...
//DÃÂGITOS   VERIFICADORES  DA  CHAVE  DE   25 POSIÃÂÃÂES - Digito V2
...
function monta_linha_digitavel($codigo) {
	...
	// 20 a 26  CÃÂ³digo do Cedente
	// 27 a 39  CÃÂ³digo do Documento
	// 40 a 43  Data de Vencimento em Juliano (mmmy)
	// 44       CÃÂ³digo do aplicativo CNR = 2
