...
$codigobanco = "151"; //CÃÂ³digo do banco de acordo com o banco central
...
//conta cedente (sem dv) ÃÂ© 6 digitos
...
//nosso nÃÂºmero (sem dv) ÃÂ© 9 digitos
$nnum = $dadosboleto["inicio_nosso_numero"] . formata_numero($dadosboleto["nosso_numero"],7,0);

//Agencia sem o digito + modalidade convertida e conta sem o dÃÂ­gito
...
//Calcula o digito verificador do nosso nÃÂºmero
...
//pega o nosso numero a partir da 2ÃÂº posiÃÂ§ÃÂ£o
$nnum = substr($nnum,1);

//numero para o calculo dos dÃÂ­gitos verificadores da posiÃÂ§ÃÂ£o 43 e 44
$calcdv1 = $prefixo.$nnum.$ag_contacedente.$codigobanco;

//Gera os dÃÂ­gitos verificadores da posiÃÂ§ÃÂ£o 43 e 44
$dv1 = geraDv43($calcdv1);
$dv2 = geraDv44("$calcdv1$dv1");

//Se vier 2 caracteres significa que o dv2 deu 1 entÃÂ£o o dv1 e o dv2 foi recalculado e retornado nesta string(Coisa do manual do banco =D !)
if (strlen($dv2) == 2){
	$dv1= substr($dv2,0,1);
	$dv2= substr($dv2,1,1);
}
