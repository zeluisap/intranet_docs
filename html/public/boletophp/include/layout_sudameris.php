...
<table cellspacing=0 cellpadding=0 border=0>
	...
	<tr>
		...
		<td class=ct>AgÃÂªncia/CÃÂ³digo do Cedente</td>
		<td><img src=imagens/1.png width=1 height=13></td>
	...
	<tr>
		...
		<td><img src=imagens/1.png width=1 height=13></td>
		<td class=ct>NÃÂºmero do documento</td>
		<td><img src=imagens/1.png width=1 height=13></td>
		<td class=ct>EspÃÂ©cie</td>
		<td><img src=imagens/1.png width=1 height=13></td>
	...
	<tr>
		...
		<td><img src=imagens/1.png width=1 height=13></td>
		<td class=ct>(-) Outras deduÃÂ§ÃÂµes</td>
		<td><img src=imagens/1.png width=1 height=13></td>
		<td colspan=3 class=ct>(+) Mora / Multa</td>
		<td><img src=imagens/1.png width=1 height=13></td>
		<td class=ct>(+) Outros acrÃÂ©scimos</td>
		<td><img src=imagens/1.png width=1 height=13></td>
	...
	<tr>
		...
		<td><img src=imagens/1.png width=1 height=13></td>
		<td class=ct>Nosso nÃÂºmero</td>
	</tr>
	<tr>
		<td height=12><img src=imagens/1.png width=1 height=12></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		...
		<td width=88 class=ct>AutenticaÃÂ§ÃÂ£o mecÃÂ¢nica</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
...
<table cellspacing=0 cellpadding=0 border=0 height="2">
	...
	<tr>
		<td height=12><img src=imagens/1.png width=1 height=12></td>
		<td colspan=11 class=cp>PagÃÂ¡vel em qualquer Banco atÃÂ© o vencimento.</td>
		<td><img src=imagens/1.png width=1 height=12></td>
		<td class=cp align=right><?php echo $dadosboleto["data_vencimento"]?></td>
	</tr>
	...
	<tr>
		...
		<td><img src=imagens/1.png width=1 height=13></td>
		<td class=ct>AgÃÂªncia/CÃÂ³digo cedente</td>
	</tr>
	<tr>
		<td height=12><img src=imagens/1.png width=1 height=12></td>
	...
	<tr>
		...
		<td><img src=imagens/1.png width=1 height=13></td>
		<td colspan=3 class=ct>NÃÂºmero do documento</td>
		<td><img src=imagens/1.png width=1 height=13></td>
		<td class=ct>EspÃÂ©cie doc.</td>
		<td><img src=imagens/1.png width=1 height=13></td>
...
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		...
		<td width=472 rowspan=9 valign=top>
			<span class=ct>InstruÃÂ§ÃÂµes (Texto de responsabilidade do cedente)</span><br>
			&nbsp;<br>
	...
	<tr>
		...
		<td valign=bottom><span class=ct>CÃÂ³d. baixa</span></td>
	</tr>
	<tr><td colspan=4 height=1><img src=imagens/2.png width=666 height=1></td></tr>
</table>
<table cellspacing=0 cellpadding=0 border=0>
	<tr>
		...
		<td width=333 class=ct align=right>AutenticaÃÂ§ÃÂ£o mecÃÂ¢nica - <span class=cp>Ficha de CompensaÃÂ§ÃÂ£o</span></td>
	</tr>
