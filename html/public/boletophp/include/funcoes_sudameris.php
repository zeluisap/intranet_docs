...
//nosso nÃÂºmero: 13 digitos
$nossonum = formata_numero($dadosboleto["nosso_numero"], 13, 0);

// Calcula o DigitÃÂ£o da CobranÃÂ§a
...
function monta_linha_digitavel($dados) {
	// PadrÃÂ£o: Sudameris
	// POSIÃÂÃÂO	CONTEÃÂDO
	// 1 a 3	NÃÂºmero do banco
	// 4		CÃÂ³digo da Moeda
	// 5 a 8	AgÃÂªncia
	// 9 a 15	Conta
	// 16		DigitÃÂ£o
	// 17 a 29	Nosso nÃÂºmero
	// 30		DÃÂ­gito do cÃÂ³digo de barra
