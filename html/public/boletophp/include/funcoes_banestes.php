...
//nosso nÃÂºmero (sem dv) sÃÂ£o 8 digitos
$nossonumero_sem_dv = substr($dadosboleto["nosso_numero"],0,8);

//dvs do nosso nÃÂºmero
...
//conta corrente (sem dv) sÃÂ£o 11 digitos
$conta = formata_numero($dadosboleto["conta"],11,0);

// Chave ASBACE 25 dÃÂ­gitos
...
/*
// ComposiÃÂ§ÃÂ£o da Linha DigitÃÂ¡vel
// Primeiro Campo
