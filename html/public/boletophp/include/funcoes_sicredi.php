...
//agencia ÃÂ© 4 digitos
$agencia = formata_numero($dadosboleto["agencia"],4,0);
//posto da cooperativa de credito ÃÂ© dois digitos
$posto = formata_numero($dadosboleto["posto"],2,0);
//conta ÃÂ© 5 digitos
$conta = formata_numero($dadosboleto["conta"],5,0);
//dv da conta
$conta_dv = formata_numero($dadosboleto["conta_dv"],1,0);
//carteira ÃÂ© 2 caracteres
...
function digitoVerificador_nossonumero($numero) {
	...
	// esta rotina sofrer algumas alteraÃÂ§ÃÂµes para ajustar no layout do SICREDI
	 $digito = 11 - $resto2;
     if ($digito > 9 ) {
        $dv = 0;
     } else {
...
function digitoVerificador_campolivre($numero) {
     $resto2 = modulo_11($numero, 9, 1);
// esta rotina sofreu algumas alteraÃÂ§ÃÂµes para ajustar no layout do SICREDI
	if ($resto2 <=1){
		$dv = 0;
	}else{
		$dv = 11 - $resto2;
...
function monta_linha_digitavel($codigo) {
	...
	// PosiÃÂ§ÃÂ£o | Larg | ConteÃÂºdo
	// --------+------+---------------
        // 1 a 3   |  03  | IdentcaÃÂ§ÃÂ£o do banco
        // 4       |  01  | CÃÂ³digo da Moeda - 9 para R$
        // 5       |  01  | Digito verificador geral do CÃÂ³digo de Barras
