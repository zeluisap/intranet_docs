...
$nummoeda = "9";
$fixo     = "9";   // Numero fixo para a posiÃÂ§ÃÂ£o 05-05
...
// nosso nÃÂºmero (com dvs) sÃÂ£o 13 digitos
...
function modulo_11_invertido($num)  // Calculo de Modulo 11 "Invertido" (com pesos de 9 a 2  e nÃÂ£o de 2 a 9)
{ 
   $ftini = 2;
   $fator = $ftfim = 9;
   $soma = 0;
...
{ 
	...
	// 30 a 30  DÃÂ­gito verificador do cÃÂ³digo de barras
	// 31 a 34  Fator de vencimento (qtdade de dias desde 07/10/1997 atÃÂ© a data de vencimento)
	// 35 a 44  Valor do tÃÂ­tulo
	
	// 1. Primeiro Grupo - composto pelo cÃÂ³digo do banco, cÃÂ³digo da moÃÂ©da, Valor Fixo "9"
  ...
  $campo1 = substr($campo1, 0, 5).'.'.substr($campo1, 5);
	...
	// 2. Segundo Grupo - composto pelas 3 ÃÂºltimas posiÃÂ§oes do PSK e 7 primeiros dÃÂ­gitos do Nosso NÃÂºmero
