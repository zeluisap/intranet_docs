...
#instr_header {
	background: url('<?php echo $base_url; ?>/boletophp/imagens/logo_empresa.png') no-repeat top left;
	padding-left: 160px;
	height: 65px;
}
...
do Pagador</b></div></TD></tr></tbody></table>
		...
		<tbody>
		<tr>
			<td width=150><IMG SRC="<?php echo $base_url; ?>/boletophp/imagens/logobb.jpg"></td>
			<td width=50>
		...
		<tr class="campos">
			<td class="local_pagto">Pagável em qualquer banco.</td>
