...
function monta_linha_digitavel($codigo) {
	...
	// 01-03    -> CÃÂ³digo do banco sem o digito
	// 04-04    -> CÃÂ³digo da Moeda (9-Real)
	// 05-05    -> DÃÂ­gito verificador do cÃÂ³digo de barras
	// 06-09    -> Fator de vencimento
	// 10-19    -> Valor Nominal do TÃÂ­tulo
	// 20-44    -> Campo Livre (Abaixo)
	
	// 20-23    -> CÃÂ³digo da Agencia (sem dÃÂ­gito)
	// 24-05    -> NÃÂºmero da Carteira
	// 26-36    -> Nosso NÃÂºmero (sem dÃÂ­gito)
	// 37-43    -> Conta do Cedente (sem dÃÂ­gito)
	// 44-44    -> Zero (Fixo)
        ...
        $p2 = substr($codigo, 19, 5);						// 5 primeiras posiÃÂ§ÃÂµes do campo livre
        $p3 = modulo_10("$p1$p2");						// Digito do campo 1
        $p4 = "$p1$p2$p3";								// UniÃÂ£o
        $campo1 = substr($p4, 0, 5).'.'.substr($p4, 5);

        // 2. Campo - composto pelas posiÃÂ§oes 6 a 15 do campo livre
        // e livre e DV (modulo10) deste campo
        $p1 = substr($codigo, 24, 10);						//PosiÃÂ§ÃÂµes de 6 a 15 do campo livre
        ...
        // e livre e DV (modulo10) deste campo
        $p1 = substr($codigo, 34, 10);						//PosiÃÂ§ÃÂµes de 16 a 25 do campo livre
