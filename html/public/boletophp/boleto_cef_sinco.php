...
$dadosboleto["inicio_nosso_numero"] = "9";          // Inicio do Nosso numero - obrigatoriamente deve comeÃÂ§ar com 9;
$dadosboleto["nosso_numero"] = "19525086";  // Nosso numero sem o DV - REGRA: MÃÂ¡ximo de 16 caracteres! (Pode ser um nÃÂºmero sequencial do sistema, o cpf ou o cnpj)
...
$dadosboleto["conta_cedente"] = "057335"; // ContaCedente do Cliente, sem digito (Somente NÃÂºmeros)
$dadosboleto["conta_cedente_dv"] = ""; // Digito da ContaCedente do Cliente
$dadosboleto["carteira"] = "SR";  // CÃÂ³digo da Carteira: pode ser SR (Sem Registro) ou CR (Com Registro) - (Confirmar com gerente qual usar)
