...
$dadosboleto["nosso_numero"] = "1234567";  // Nosso numero - REGRA: MÃÂ¡ximo de 7 caracteres!
...
$dadosboleto["codigo_cedente"] = "40013012168"; // CÃÂ³digo do cedente (Somente 11 digitos)
$dadosboleto["ponto_venda"] = "400"; // Ponto de Venda = Agencia 
$dadosboleto["carteira"] = "COB";  // COB - SEM Registro
$dadosboleto["nome_da_agencia"] = "ACLIMAÃÂÃÂO";  // Nome da agencia (Opcional)
